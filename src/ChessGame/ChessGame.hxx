...
private:
    ...
    */
    Vector2i uciFormatToPosition(const std::string& position);
    ...
    */
    const std::string& positionToUciFormat(const Vector2i& position);

    /* Compute the allowedNextPositions matrix for a specific piece */
    void computePAWNNextPositions();
    void computeROOKNextPositions();
    void computeKNIGHTNextPositions();
    void computeBISHOPNextPositions();
    void computeKINGNextPositions();
